...
//  public SubscribersCount getSubscriberCount(Event event);

    public List<User> getSubscribers(Event event, int limit);

    public List<Event> getAllEvents();
    
    //public SubscribingCount getSubscribingCount(Event e);

    //public List<Event> getSubscribing(Event event, int limit);
}
